...
const { getShinobiDbConfig } = require('../dist/config/shinobi.js');
async function getShinobiKeys() {
    ...
    try {
        ...
        const [rows] = await connection.query('SELECT uid, email, auth_token, api_key FROM Users LIMIT 10');
...
//# sourceMappingURL=get-shinobi-keys.js.map